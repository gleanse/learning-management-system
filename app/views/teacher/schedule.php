    ...
    <div class="d-flex">
        <div class="sidenav" id="sidebar">
            ...
            <ul class="sidenav-menu">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="index.php?page=teacher_schedule">
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item">
                            <a href="index.php?page=teacher_dashboard"><i class="bi bi-house-door-fill"></i> Dashboard</a>
                        </li>
                                                        ...
                                                        <div class="class-card">
                                                            ...
                                                            <div class="class-meta">
                                                                <span class="class-section">
                                                                    ...
                                                                    <?php echo htmlspecialchars($class['section_name']) . ' (' . htmlspecialchars($class['year_level']) . ')'; ?>
                                                                </span>
