...
<head>
    ...
    <title>Create Section - LMS</title>
...
<body>
                ...
                <div class="page-header">
                    <div class="header-content">
                        ...
                        <div class="header-text">
                            <h1 class="header-title">Create New Section</h1>
                            <p class="header-subtitle">Add a new section to the system</p>
                        </div>
                    </div>
                </div>
    ...
    <script>
        ...
        function updateDropdowns() {
            ...
            const currentYearValue = yearLevelSelect.value;
            ...
            if (selectedLevel) {
                ...
                if (currentYearValue) {
                    const exists = [...yearLevelSelect.options].some(o => o.value === currentYearValue);
                    if (exists) yearLevelSelect.value = currentYearValue;
                }
            }
        }
