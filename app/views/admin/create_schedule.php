...
<head>
    ...
    <title>Create Schedule - LMS</title>
        ...
        <div class="main-content flex-grow-1">
            ...
            <div class="container-fluid p-4">
                ...
                <div class="page-header">
                    <div class="header-content">
                        ...
                        <div class="header-text">
                            <h1 class="header-title">Create New Schedule</h1>
                            <p class="header-subtitle">Add a new class schedule for a teacher</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="card form-card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="index.php?page=create_schedule" id="scheduleForm">
                            ...
                            <div class="row g-3">
                                    ...
                                    <select class="form-select <?= !empty($errors['teacher_id']) ? 'is-invalid' : '' ?>"
                                        ...
                                        <?php foreach ($teachers as $teacher): ?>
                                            <option value="<?= $teacher['id'] ?>"
                                                <?= ($old_input['teacher_id'] ?? '') == $teacher['id'] ? 'selected' : '' ?>>
                                    ...
                                    <select class="form-select <?= !empty($errors['subject_id']) ? 'is-invalid' : '' ?>"
                                        ...
                                        <?php foreach ($subjects as $subject): ?>
                                            <option value="<?= $subject['subject_id'] ?>"
                                                <?= ($old_input['subject_id'] ?? '') == $subject['subject_id'] ? 'selected' : '' ?>>
                                    ...
                                    <select class="form-select <?= !empty($errors['section_id']) ? 'is-invalid' : '' ?>"
                                        ...
                                        <?php foreach ($sections as $section): ?>
                                            <option value="<?= $section['section_id'] ?>"
                                                <?= ($old_input['section_id'] ?? '') == $section['section_id'] ? 'selected' : '' ?>>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select class="form-select <?= !empty($errors['day_of_week']) ? 'is-invalid' : '' ?>"
                                        ...
                                        <option value="Monday" <?= ($old_input['day_of_week'] ?? '') === 'Monday' ? 'selected' : '' ?>>Monday</option>
                                        <option value="Tuesday" <?= ($old_input['day_of_week'] ?? '') === 'Tuesday' ? 'selected' : '' ?>>Tuesday</option>
                                        <option value="Wednesday" <?= ($old_input['day_of_week'] ?? '') === 'Wednesday' ? 'selected' : '' ?>>Wednesday</option>
                                        <option value="Thursday" <?= ($old_input['day_of_week'] ?? '') === 'Thursday' ? 'selected' : '' ?>>Thursday</option>
                                        <option value="Friday" <?= ($old_input['day_of_week'] ?? '') === 'Friday' ? 'selected' : '' ?>>Friday</option>
                                        <option value="Saturday" <?= ($old_input['day_of_week'] ?? '') === 'Saturday' ? 'selected' : '' ?>>Saturday</option>
                                        <option value="Sunday" <?= ($old_input['day_of_week'] ?? '') === 'Sunday' ? 'selected' : '' ?>>Sunday</option>
                                    </select>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="time" class="form-control <?= !empty($errors['start_time']) ? 'is-invalid' : '' ?>"
                                        name="start_time" id="startTime" value="<?= htmlspecialchars($old_input['start_time'] ?? '') ?>" required>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="time" class="form-control <?= !empty($errors['end_time']) ? 'is-invalid' : '' ?>"
                                        name="end_time" id="endTime" value="<?= htmlspecialchars($old_input['end_time'] ?? '') ?>" required>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control <?= !empty($errors['room']) ? 'is-invalid' : '' ?>"
                                        ...
                                        value="<?= htmlspecialchars($old_input['room'] ?? '') ?>">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select class="form-select <?= !empty($errors['school_year']) ? 'is-invalid' : '' ?>"
                                        ...
                                        <option value="2025-2026" <?= ($old_input['school_year'] ?? '2025-2026') === '2025-2026' ? 'selected' : '' ?>>2025-2026</option>
                                        <option value="2024-2025" <?= ($old_input['school_year'] ?? '2025-2026') === '2024-2025' ? 'selected' : '' ?>>2024-2025</option>
                                    </select>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select class="form-select <?= !empty($errors['semester']) ? 'is-invalid' : '' ?>"
                                        ...
                                        <option value="First" <?= ($old_input['semester'] ?? 'First') === 'First' ? 'selected' : '' ?>>First Semester</option>
                                        <option value="Second" <?= ($old_input['semester'] ?? 'First') === 'Second' ? 'selected' : '' ?>>Second Semester</option>
                                    </select>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select class="form-select <?= !empty($errors['status']) ? 'is-invalid' : '' ?>"
                                        ...
                                        <option value="inactive" <?= ($old_input['status'] ?? 'active') === 'inactive' ? 'selected' : '' ?>>Inactive</option>
                                    </select>
