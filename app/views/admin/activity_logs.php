    ...
    <div class="d-flex">
        ...
        <div class="sidenav" id="sidebar">
            ...
            <ul class="sidenav-menu">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="index.php?page=admin_activity_logs">
            ...
            <div class="container-fluid p-4">
                        ...
                        <form method="GET" action="index.php" id="filterForm">
                            ...
                            <div class="row mt-3">
                                ...
                                <div class="col-md-4 d-flex gap-2">
                                    ...
                                    <a href="index.php?page=admin_activity_logs" class="btn btn-outline-secondary">
                ...
                <div class="card logs-card">
                    <div class="card-header d-flex align-items-center justify-content-between">
                        ...
                        <a href="index.php?page=admin_activity_logs&action=export&<?= http_build_query($_GET) ?>"
                        ...
                        <?php if (empty($logs)): ?>
                            <div class="empty-state py-5">
                                ...
                                <?php if (!empty($filters)): ?>
                                    <button class="btn btn-outline-primary mt-3" onclick="window.location.href='index.php?page=admin_activity_logs'">
                                        <i class="bi bi-arrow-counterclockwise"></i>
                                        Clear Filters
                                    </button>
                                <?php endif; ?>
