                ...
                <div class="page-header mb-4">
                    <div class="header-content">
                        ...
                        <div class="header-text">
                            ...
                            <p class="header-subtitle">Choose a year level to view your grades</p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-body">
                        <?php if (empty($year_levels)): ?>
                            <div class="empty-state">
                                ...
                                <p class="empty-state-subtext">Year levels will appear here once you are enrolled.</p>
                            </div>
                        <?php else: ?>
                                ...
                                <?php foreach ($year_levels as $level): ?>
                                    <a href="index.php?page=student_semesters&year_level=<?php echo urlencode($level['year_level']); ?>"
                                        ...
                                        <div class="year-level-content">
                                            <h5 class="year-level-title"><?php echo htmlspecialchars($level['year_level']); ?></h5>
