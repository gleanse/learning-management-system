...
$(document).ready(function() {
    ...
    console.log('AJAX Response:', response); // Tingnan sa console
    
    // Show debug info kung meron
    if (response.debug) {
...
error: function(xhr, status, error) {
    ...
    console.log('Response Text:', xhr.responseText); // IMPORTANT: Tingnan kung ano ang laman
    
    $('#loading-spinner').hide();
    
    // Ipakita ang actual na response para makita ang extra output
    $('#filter-status').text('Error: Check console (F12)');
    
    // Show error sa table
    $('#table-body').html('<tr><td colspan="16" class="text-center text-danger">' +
